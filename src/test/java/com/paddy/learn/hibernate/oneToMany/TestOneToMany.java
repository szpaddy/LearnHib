...
public class TestOneToMany {
	...
	public void testOneToMany() throws SQLException {
		try {
			...
			tx.commit();
			/*
			 * 输出如下: Hibernate: insert into classes (name) values (?) Hibernate:
			 * insert into student (classid, sname) values (?, ?) Hibernate:
			 * insert into student (classid, sname) values (?, ?)
			 */
			/*
			...
			/*
			 * 输出如下: Hibernate: insert into student (classid, sname) values (?,
